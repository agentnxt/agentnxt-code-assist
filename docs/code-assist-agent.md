# AGenNext CodeAssist Production Contract

CodeAssist is the agent (requester/planner), not the enforcement point.
...
- ANP/ACP/Agent Client Protocol/A2A are configuration metadata, not direct clients in CodeAssist.
